...
import {useSendReclamationMutation} from '../../API/ClientApi';
        ...
        {({
          ...
          <View style={styles.miniContainer}>
            ...
            <Modal
              ...
              style={{backgroundColor: colors.main.backgroundColor}}
              onRequestClose={() => {
